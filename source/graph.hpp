...
//------------------------------------------------------------------------------------------------
{
    ...
    using stream = interleaved_stream<signal_t, memallocator<signal_t>>;
...
//------------------------------------------------------------------------------------------------
{
    ...
    // down the line, we could even template node,
    // allowing to choose a stream type for each implementation
    using stream = non_interleaved_stream<signal_t, memallocator<signal_t>>;
    ...
    //------------------------------------------------------------------------------------------------
    {
        ...
        public:
        stream::accessor& operator[](std::string);
    };
    ...
    stream::accessor collect(polarity_t);
...
//------------------------------------------------------------------------------------------------
{
    ...
    static stream::accessor run(node& target);
...
//------------------------------------------------------------------------------------------------=
{
    ...
    private:
    channel<signal_t, stack_allocator<signal_t, 16384>>
    m_wavetable;
};
